...
findRepMovContext * createRepMovContext(int numTmpVars)
{
  ...
  newContext = (findRepMovContext *) VG_(malloc)(sizeof(findRepMovContext)); 
  newContext->subTmpVars = (int *) VG_(calloc)(numTmpVars,sizeof(int)); 
  newContext->cmpZeroTmpVars = (int *) VG_(calloc)(numTmpVars,sizeof(int)); 
...
void findRepMovIRStmt(IRBB * bb, IRStmt * s, findRepMovContext * context, UInt tagVal)
{
