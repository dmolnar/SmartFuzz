...
void cgAddTmpBinopConstraints(IRBB * bb, IRStmt * s)
{
  IRExpr * rhs;
  IRExpr * arg1;
  IRExpr * arg2;
  ...
  switch (arg1->tag)
    ...
    case(Iex_Tmp):
      ...
      arg1tmp = (HWord)arg1->Iex.Tmp.tmp;
	...
	{
	case (Iex_Tmp):
	  arg2tmp = (HWord)arg2->Iex.Tmp.tmp; 
	  arg2ty = bb->tyenv->types[arg2tmp]; 
	 
	  extra_args3 = VG_(malloc)(sizeof(cgArgs_EmitTmpBinopTmpTmp));
	  ...
	  d = unsafeIRDirty_0_N(0,
				...
				mkIRExprVec_3(
					  ...
					  IRExpr_Tmp(arg1->Iex.Tmp.tmp),
					  IRExpr_Tmp(arg2->Iex.Tmp.tmp) 
					  )
			    );
	  setHelperAnns(d);
	...
	case (Iex_Const):
	  ...
	  // taking care of extra arguments                                                                                                    
	    extra_args1 = VG_(malloc)(sizeof(cgArgs_EmitTmpBinopTmpConst));
	...
	case (Iex_Tmp):
	  arg2tmp = (HWord) arg2->Iex.Tmp.tmp; 
	  arg2ty = bb->tyenv->types[arg2tmp]; 
	  extra_args2 = VG_(malloc)(sizeof(cgArgs_EmitTmpBinopConstTmp));
	...
	case (Iex_Const):
	  arg2val = cgConstToHword(arg2); 
          ...
          // taking care of extra arguments                                                                                    
          extra_args = VG_(malloc)(sizeof(cgArgs_EmitTmpBinopConstConst));
			   ...
			   )
{
  ...
  if (! arg1SymP && arg2SymP )
  {
    ...
    cgArgs_EmitTmpBinopConstTmp *extra_args1 = VG_(malloc)(sizeof(cgArgs_EmitTmpBinopConstTmp));
    extra_args1->theop = theop;
  ...
  if ( arg1SymP && ! arg2SymP )
  {
    cgArgs_EmitTmpBinopTmpConst *extra_args1 = VG_(malloc)(sizeof(cgArgs_EmitTmpBinopTmpConst));
    extra_args1->theop = theop;
    extra_args1->tagVal = tagVal;
    extra_args1->lhsty = lhsty;
    extra_args1->arg1ty = arg1ty;
