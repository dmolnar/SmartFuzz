...
# No longer require CPU 3000, gives us 20 more machines to play with!
print "#PBS -l nodes=1,walltime=24:20:00\n"; 
...
$lib32path = "/work/dmolnar/tmplib32/lib"; 

print "export CC_TEST_PREFIX=$prefix\n"; 
print "export VG_CC_PATH=$valgrind\n"; 
print "export ZZUF_PATH=$zzuf_path\n"; 
print "export MPLAYERPATH=$mplayerpath\n"; 
print "export STP_PATH=$stp\n"; 
print "export MF_EMAIL=$mf_email\n"; 
print "export LD_LIBRARY_PATH=$lib32path:\$LD_LIBRARY_PATH \n";
print "export MF_KEEPTESTCASES=1\n"; 
...
print "/usr/X11R6/bin/perl $prefix/$jobname/$scriptname $inputname $mplayerpath $inputname < /dev/null\n"; 
